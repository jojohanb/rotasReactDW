    ...
    return(
        <Pagina titulo="useRef" subtitulo="Hooks basicos">
            <div className="flex flex-col">
                ...
                <div>
                    <button className="bg-purple-400 px-3 py-2 rounded-md mr-2" onClick={incrementaReferencia}>
                        Ref +
                    </button>
                ...
                <div className="mt-6">
                    ...
                    <button className="bg-purple-400 px-3 py-2 rounded-md ml-2" onClick={() => refTexto.current.innerHTML = refInput.current.value}>
                        ok
                    </button>

                    <p ref={refTexto} className="text-2xl"> </p>
                </div>
            </div>
